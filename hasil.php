	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<div class="col-md-4">
				<table class="table">
					<tr>
						<td>Jumalah Sudah Memilih</td><td>:</td><td><?php echo $sm." orang" ?></td>
					</tr>
					<tr>
						<td>Jumalah belum Memilih</td><td>:</td><td><?php echo $bm." orang" ?></td>
					</tr>
					<tr>
						<td>Jumalah Semua Pemilih</td><td>:</td><td><?php echo $p." orang" ?></td>
					</tr>
				</table>
			</div>
