				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							<li class="act"><a href="index.php">Pemilihan</a></li>
							...
							<li>
								<div class="banner-info">
									<div class="dummy_text">
										<h1 style="color:black;">Selamat Datang di Sistem  Pemilihan Umum Calon Ketua Himpunan Mahasiswa Sistem Informasi Online
										</h1>
										</h1>
									</div>
								</div>
		...
		<div class="banner-bottom1-grids">
			...
			<div class="col-md-4 banner-bottom1-left banner-bottom1-left2">
				<div class="banner-bottom1-lft">
					...
					<p> dapatkan semua informasi mengenai pemilu secara cepat dan lengkap</p>
				</div>
			</div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-copy">
				<p>&copy 2016 Election. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a></p>
				<p>Developed by <a href="#">Wahyu Budiman</a></p>
			</div>
		</div>
	</div>
<!-- //footer -->
